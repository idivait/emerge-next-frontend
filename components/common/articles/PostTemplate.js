...
// import ArticleContent from '@components/common/articles/ArticleContent';
...
const PostTemplate = ({ post, next, prev, TOC }) => {
    ...
    return (
        ...
        //                             {post.tags.length > 0 && (
        //                                 <p className="tags">
        //                                     <strong className="padding-bottom">Tagged:</strong>
        //                                     {tags.map((tag) => {
